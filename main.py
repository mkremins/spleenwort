...
Write the first paragraph of the story. In this paragraph, {{follow_instruction}}. Use two or five sentences in the paragraph based on the case.
""".strip()

followup_prompt = """
Write the next paragraph of the story. Remember the story is about: {{user_input_text}}. In this paragraph, {{follow_instruction}}. Use two or five sentences in the paragraph based on the case.
""".strip()
...
Write the first paragraph of the story. Use two or five sentences in the paragraph based on the case.
""".strip()

naive_followup_prompt = """
Write the next paragraph of the story. Remember the story is about: {{user_input_text}}. Use two or five sentences in the paragraph based on the case.
""".strip()
