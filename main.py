...
Write the first paragraph of the story. In this paragraph, {{follow_instruction}}. Use two or three or four or five sentences in the paragraph based on the need.
""".strip()

followup_prompt = """
Write the next paragraph of the story. Remember the story is about: {{user_input_text}}. In this paragraph, {{follow_instruction}}. Use two or three or four or five sentences in the paragraph based on the need.
""".strip()
...
Write the first paragraph of the story. Use two or three or four or five sentences in the paragraph based on the need.
""".strip()

naive_followup_prompt = """
Write the next paragraph of the story. Remember the story is about: {{user_input_text}}. Use two or three or four or five sentences in the paragraph based on the need.
""".strip()
